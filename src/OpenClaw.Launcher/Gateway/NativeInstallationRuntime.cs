...
internal sealed class NativeInstallationRuntime
{
    ...
    private readonly Func<string, Action<string>, NodeRuntime> _ensureNode;
    ...
    public NativeInstallationRuntime(
        ...
        Action<string> log,
        Func<string, Action<string>, NodeRuntime>? ensureNode = null,
        Action<string>? deleteRuntimeDirectory = null)
    {
        ...
        _ensureNode = ensureNode ?? NodeRuntimeInstaller.EnsureInstalled;
        ...
        CancellationToken cancellationToken)
    {
        ...
        string archivePath = RequireNodeArchive();
        ...
        NodeRuntime runtime = _ensureNode(archivePath, _log);
