...
test("supplies complete local-session guidance before prompt build without reading the conversation", () => {
  ...
  for (const instruction of [
    ...
    "Resolve the exact requested file and revision",
    "read and verify its current contents before attaching or copying it",
    "Do not substitute a similarly named file, an earlier deliverable, or a stale attachment",
    "Preserve private originals",
    "Verify recipient-side access or delivery",
    "A clickable path is not proof of a working attachment or download",
